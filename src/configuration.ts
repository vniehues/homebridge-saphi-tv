...
export class Configuration {
    ...
    constructor(public readonly config: PlatformConfig) {
      ...
      // urls
      this.power_url = this.protocol + '://' + this.ip_address + ':' + this.port_no + '/' + this.api_version + '/powerstate';
      this.ambihue_url = this.protocol + '://' + this.ip_address + ':' + this.port_no + '/' + this.api_version + '/HueLamp/power';
      this.input_url = this.protocol + '://' + this.ip_address + ':' + this.port_no + '/' + this.api_version + '/input/key';
